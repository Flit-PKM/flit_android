...
private const val TAG = "NotesByCategoryScreen"

/**
 * Notes by category screen that displays filtered notes for a specific category.
 */
@Composable
fun NotesByCategoryScreen(
    categoryId: Long,
    ...
    Timber.tag(TAG).d("Displaying notes for category: $categoryId, count: ${notes.size}")
